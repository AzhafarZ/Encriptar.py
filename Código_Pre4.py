...
while 1:
  ...
  #mensajes de error
  if user >6:
      print("\n Error. Se escribió un número mayor que 5, por favor introduce un número del 1 al 6 sin decimales. \n")
  elif user<0:
      print("\n Error. Se introdujo un número menor que 1, por favor favor introduce un número del 1 al 6 sin decimales. \n")

  if user==0:                                                                   #si el usuario ya tiene clave
    for i in range(2):
      for j in range(2):
    ...
    if valida(deter[0])==bool(1):                                               #si la clave es válida
      ...
      print("BBVA clave no valida, use una porpocionada por el sistema de cifrado oficial")
      print("para calquier inconveniente comuníquese con soporte técnico ")
...
#**********************************************************
    ...
    print(" [2] No")
    user=int(input())
    if user== 1:                                                                #si el mensaje del usuario ya está encriptado
